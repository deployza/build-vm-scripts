...
# -----------------------------------------------------------------------------
# Container variant of assess-exam.sh.
#
# This is the DOCKER counterpart of vm/assess-exam.sh. It is intentionally a
...
#
# assess-exam is a STATIC UI WAR: no database, no app.properties, no external
...
#
# Differences from vm/assess-exam.sh:
...
# <clone>/docker/assess-exam.sh — so the name is already implied.) Only APP_ENV
# varies (development/production) and is the sole argument.
APP_NAME="assess-exam"
